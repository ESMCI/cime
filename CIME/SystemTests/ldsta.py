...
class LDSTA(SystemTestsCommon):
    ...
    def run_phase(self):
        ...
        start_date = _date_to_datetime(
            get_file_date(self._case.get_value("RUN_STARTDATE"))
        )
