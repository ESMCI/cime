...
:ref:`User's guide - Part 2 <users-guide1>`: porting and CIME scripting internals

:ref:`User's guide - Part 3 <users-guide2>`: advance use of the scripting infrastructure.
