...
mpirun.lsf python pyEnsSum.py --indir /glade/scratch/abaker/monthly_allcompilers/ --esize 150  --verbose --tslice 1  --tag cesm1_3_beta06 --sumfile /glade/scratch/haiyingx/gm.cumul.150.nc --jsonfile beta06_ens_excluded_varlist.json --cumul --mpi_enable  --compset FC --mach ys --res ne30-ne30 --startMon 1 --endMon 2 --fIndex 151
