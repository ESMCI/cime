...
#
def CECT_usage():
    print '\n Compare 3 runs to an ensemble summary file. \n'
    print '  ----------------------------'
    ...
    print '   --sumfile  <ifile>      : the ensemble summary file (generated by pyEc.py)'
    ...
    print '   --nPC <num>             : number of principal components (PCs) to check (dfault = 50, but can\'t be greater than the number of variables)'
...
def Ec_usage(): 
    ...
    print '   -h                   : prints out this usage message'
    print '   --verbose            : prints out in verbose mode (turned off by default)'
    print '   --sumfile    <ofile> : the output summary data file (default = pyEc.ens.summary.nc)'
