...
sub setMachineFile
{
    my ($machine, $cimeroot, $srcroot, $definitions_file) = @_;
    ...
    if (@nodes) {
	print "\n Found machine \"$machine\" in $machines_file \n";
    } else {
...
sub setMachineValues
{
    ...
    my ($machines_file, $machines_dir, $machine, $compiler, $print_flag, $cfg_ref) = @_;
