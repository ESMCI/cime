...
class Case(object):
    ...
    def _valid_compset_impl(self, compset_name, compset_alias, comp_classes, comp_hash):
        ...
        >>> Case(read_only=False)._valid_compset_impl('1850_DATM_CTSM51%BGC-CROP_SICE_SOCN_MOSART_CISM2%NOEVOLVE_SWAV', None,
        >>> ['CPL', 'ATM', 'LND', 'ICE', 'OCN', 'ROF', 'GLC', 'WAV', 'ESP'], {'datm':1,'satm':1, 'dlnd':2,'ctsm':2, 'clm':2,'slnd':2,'dice':3,'sice':3,'docn':4,'socn':4,'mosart':5,'drof':5,'srof':5,'cism':6,'sglc':6,'swav':7,'sesp':8})
        ('1850_CAM60_CLM50%BGC-CROP_CICE_POP2%ECO%ABIO-DIC_MOSART_CISM2%NOEVOLVE_WW3_SESP_BGC%BDRD', ['1850', 'CAM60', 'CLM50%BGC-CROP', 'CICE', 'POP2%ECO%ABIO-DIC', 'MOSART', 'CISM2%NOEVOLVE', 'WW3', 'SESP'])
