...
def _main_func(desc):
    ...
    print("caseroots are {}".format(caseroots))
    print("t caseroots are {}".format(templatevars["caseroots"]))
    templatevars["member_nodes"] = check_cases(caseroots)
