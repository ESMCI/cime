"""
Interface to the env_mach_specific.xml file.  This class inherits from EntryID
"""
...
class EnvMachSpecific(EntryID):

    @staticmethod
    def constructEnvMachSpecific(case_root, infile = "env_mach_specific.xml"):
        return EnvMachSpecific.construct(case_root, infile)
