...
###############################################################################
def case_build(caseroot, case=None, sharedlib_only=False, model_only=False, testonly=False):
###############################################################################
    t1 = time.time()
    ...
    logger.debug("sharedlib_only is %s" % sharedlib_only)
    logger.debug("model_only is %s" % model_only)
